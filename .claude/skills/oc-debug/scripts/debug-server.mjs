#!/usr/bin/env node
// Minimal log collector for /oc-debug instrumentation.
// Client components POST JSON to http://localhost:7331/log;
// entries accumulate as NDJSON in /tmp/oc-debug.log.
//
...
const LOG_FILE = '/tmp/oc-debug.log'
...
server.listen(PORT, () => {
  console.log(`[oc-debug] log server on http://localhost:${PORT} → ${LOG_FILE}`)
})
