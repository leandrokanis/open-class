...
export function registerListEnrollmentsTool(server: McpServer, enrollmentsService: EnrollmentsService) {
  server.tool(
    'list-enrollments',
    'Lista as matrículas e o progresso de um aluno em todos os seus cursos',
    {
